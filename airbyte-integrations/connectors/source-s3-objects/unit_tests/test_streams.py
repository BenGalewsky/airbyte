...
import pytest
from source_s3_objects.source import S3ObjectsStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(S3ObjectsStream, "path", "v0/example_endpoint")
    mocker.patch.object(S3ObjectsStream, "primary_key", "test_primary_key")
    mocker.patch.object(S3ObjectsStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = S3ObjectsStream()
